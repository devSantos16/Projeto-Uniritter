        ...
        <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                    ...
                    <small class="text-muted">Clique no botão ao lado para obter mais informações sobre as mensalidades LIQUIDADAS</small>
                </div>
                <div>
                    <div class= "py-1">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalMensalidade">Detalhes</button>
                    </div>
                </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                ...
                <div class="py-1">
                    <button type="button" class="btn btn-success btn-sm" data-target="#modalTaxas" data-toggle="modal">Detalhes</button>
                </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
            ...
            <li class="list-group-item d-flex justify-content-between">
                <div>
                    ...
                    <small class="text-muted">Você não tem Mensalidades, Taxas ou Documentação em Aberto, tudo está liquidado !</small>
                </div>
                <span class="py-1">R$ 0,00</span>
            </li><br>
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                ...
                                <small style="margin-left:30px;" class="text-muted"> Essa parcela foi paga no dia <?php echo date("d/m/Y");?> </small>
                            </div>
                            <div class="py-1">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            ...
                            <span class="py-1">R$ <?php echo $valor - $valor?>,00 </span>
                        </li>
                </div>
            </div>
