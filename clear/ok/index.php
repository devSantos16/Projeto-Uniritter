        ...
        <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between">
                <div>
                    ...
                    <small class="text-muted">Soma dos valores de R0,00 das Mensalidades em atraso R$400 reais em taxas em aberto.</small>
                </div>
...
<div class="modal fade" id="modalTaxas" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="location.href='loading.php'">Pagar</button>
                <button type="button" class="btn btn-light" data-dismiss="modal">Fechar</button>
            </div>
        </div>
    </div>
