        ...
        <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between">
                <div>
                    ...
                    <small class="text-muted">Soma dos valores de R$1.800,00 das Mensalidades em atraso R$400 reais em taxas em aberto.</small>
                </div>
                <span class="py-1">R$ 2.200</span>
            </li><br>
                ...
                <div class="col-md-12 order-md-2 mb-4">
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            ...
                            <span class="py-1">R$ <?php echo $valor?>,00 </span>
                        </li>
                </div>
            </div>
